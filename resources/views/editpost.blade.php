...
<div class="container" style="margin-top:40px;margin-bottom:50px">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
           ...
           <form action="/addeditpost" method="post" enctype="multipart/form-data">
           ...
           @csrf
            <div class="card col-md-12 mt-5" style="display:flex;align-item:center;justify-content:center">
              <div class="preview">
              <img src="{{asset('images/projects')}}/{{$post->images}}" id="file-ip-1-preview"  style="width:400px;display:flex;align-item:center;justify-content:center">
              <input value="{{ Auth::user()->id }}" name="u_id" hidden>
              <input value="{{$post->id}}" name="id" hidden>
              <input type="text" name="title" class="form-control mt-1"  value="{{$post->title}}"placeholder="Your Tags">
              <textarea name="desc" class="form-control mt-2" id="" value="{{$post->descr}}">{{$post->descr}}</textarea>
